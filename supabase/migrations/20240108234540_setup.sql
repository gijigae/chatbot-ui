...
AS $$
DECLARE
  project_url TEXT := 'https://djbpouomypxzzxuinvop.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRqYnBvdW9teXB4enp4dWludm9wIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTAyOTY2MCwiZXhwIjoyMDIwNjA1NjYwfQ.qBsvGeY1CwY4Qd9u0TwO_jTeXh4zHKGDBcYYueWlopA'; -- full access needed for http request to storage
